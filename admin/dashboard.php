...
// Sertakan file penjaga sesi (redirect jika bukan admin)
...
// 3. Hitung transaksi yang menunggu approval (status pending)
...
// 6. Ambil daftar kinerja agen: jumlah transaksi approved per agen
$query_kinerja = "
...
<head>
    ...
    <style>
        ...
        /* Kartu statistik dengan border kiri berwarna */
        .stat-card {
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 p-4">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="fw-bold mb-0">
                                    <?php echo number_format($produk['stok']); ?> unit
                                </h4>
            ...
            <!-- -----------------------------------------------
             BARIS 2: Notifikasi & Tabel Kinerja Agen
             ----------------------------------------------- -->
            <div class="row g-3">
                ...
                <?php if ($request_pending > 0): ?>
                    <div class="col-12">
                        <div class="alert alert-warning d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Ada <strong>
                                    <?php echo $request_pending; ?> permintaan stok
                                </strong> dari agen yang menunggu persetujuan.
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header" style="background:#1a1a2e; color:#fff; border-radius:10px 10px 0 0;">
